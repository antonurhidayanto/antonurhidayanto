...
I am a Front-End Developer with over 5 years of experience in developing high-quality web and mobile applications. I am passionate about writing clean and efficient code, as well as creating user-friendly and enjoyable interfaces. My expertise lies in Front-End development, focusing on high-performance applications with responsive designs.

I am experienced with technologies such as React.js, Vue.js, React Native, and WordPress. In addition to my Front-End skills, I also have a solid understanding of back-end development with Express.js, MongoDB, Prisma, MySQL, and PostgreSQL, enabling me to create full-stack solutions.

I continuously follow the latest industry trends and am eager to improve my skills. My goal is to create high-performance, user-focused products, whether working on solo projects or in teams, with a commitment to excellence.

🌱 **Currently learning**: AI engineering, prompt engineering.  
🔭 **Current project**: Developing my personal portfolio website to showcase my expertise.  
👯 **Looking to collaborate on**: Innovative web projects or mobile app projects.  
💬 **Let’s talk about**: Anything related to tech! Whether it's Front-End architecture, optimizing web performance, or exploring the latest in AI and prompt engineering. I love sharing ideas and discussing the future of technology.
